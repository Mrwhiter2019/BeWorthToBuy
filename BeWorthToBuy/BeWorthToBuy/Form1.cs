    ...
    public partial class Form1 : Form
    {
        ...
        private void Compute_Click(object sender, EventArgs e)
        {
            ...
            if (this.self.Checked)//买房自住
            {
                ...
                decimal _lastmonth = Convert.ToDecimal(this.MonthEarn.Text) - (_years * 12 - 1) * Convert.ToDecimal(this.MonthMinus.Text);
                ...
                this.HouseValue.Text = (Convert.ToDecimal(this.EarnAll.Text) - Convert.ToDecimal(this.CostAll.Text) + Convert.ToDecimal(this.firstCost.Text)).ToString();
            ...
            else//出租
            {
                if (this.benjin.Checked)
                {
                    ...
                    this.MonthMinus.Text = ((decimal)Convert.ToInt64(monthBenJin * _loanMonthRate * 100) / 100).ToString();
                    this.LoanAll.Text = ((decimal)Convert.ToInt64((monthBenJin + firstMonthLiXi + _selfrent - _houserent + monthBenJin + Convert.ToDecimal(this.MonthMinus.Text) + _selfrent - _houserent) * _years * 12 / 2 * 100) / 100).ToString();
                    this.LiXiZong.Text = (Convert.ToDecimal(this.LoanAll.Text) - _loanCost).ToString();
                    this.EarnMinus.Text = this.MonthMinus.Text;
                    this.houseCost.Text = (Convert.ToDecimal(this.LoanAll.Text) + Convert.ToDecimal(this.firstCost.Text)).ToString();
                }
